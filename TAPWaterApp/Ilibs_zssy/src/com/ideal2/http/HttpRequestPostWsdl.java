...
public class HttpRequestPostWsdl implements IHttpRequestPost {
	...
	public HttpRequestPostWsdl() {
		super();
	}

	public HttpRequestPostWsdl(String url) {
		super();
	...
	@Override
	public void run() {
		SoapObject request = new SoapObject(null, wsdlParam.getMethodName());
		request.addProperty(wsdlParam.getAttrName(),
				wsdlParam.getRequestValue());
					...
					xParser.setOnXmlEndDocumentListening(
							new OnXmlEndDocumentListening() {
								...
								public void onXmlEndDocument(XmlNode xmlNode,
									...
									xnBody.addChild(xmlNode);
									onHttpResponseListener.onHttpResponse(xnBody,
											mStream, 200);
								}
							}, 1);
