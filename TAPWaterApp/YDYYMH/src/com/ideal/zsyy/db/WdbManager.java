...
public class WdbManager {
	...
	public WCBUserEntity GetWCBUserItemByNo(String stealNo) {
		...
		if (cursor.moveToNext()) {
			...
			retItem.setTotalNumberSencond(cursor.getDouble(cursor.getColumnIndex("TotalNumberSencond")));
			retItem.setAvePriceSencond(cursor.getDouble(cursor.getColumnIndex("AvePriceSencond")));
			retItem.setWaterTotalChargeSencond(cursor.getDouble(cursor.getColumnIndex("WaterTotalChargeSencond")));
	...
	public void UpdateUserItem(WCBUserEntity useritem) {
		...
		cValues.put("TotalNumberSencond", useritem.getTotalNumberSencond());
		cValues.put("AvePriceSencond", useritem.getAvePriceSencond());
		cValues.put("WaterTotalChargeSencond", useritem.getWaterTotalChargeSencond());
