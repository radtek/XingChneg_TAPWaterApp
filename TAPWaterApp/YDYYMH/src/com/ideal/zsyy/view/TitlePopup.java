...
public class TitlePopup extends PopupWindow {
	...
	public boolean checkExists(int opid)
	{
		for(ActionItem itm:mActionItems)
		{
			if(itm.operateId==opid)
			{
				return true;
			}
		}
	...
	public void removeAction(int opid)
	{
		ActionItem actionItem=null;
		for(int i=0;i<mActionItems.size();i++)
		{
			actionItem=mActionItems.get(i);
			if(actionItem.operateId==opid)
			{
				mActionItems.remove(i);
				break;
			}
		}
	}
